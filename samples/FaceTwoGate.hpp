...
FaceTwoGate::apply_displacement(const Realvec& position, const Realvec& displacement,
				const FaceBase_sptr& ptr ) 
{
// debug
...
std::pair<Real, Real> 
FaceTwoGate::translate_pos(std::pair<Real, Real> pos, const int edge_id, FaceBase_sptr face_ptr)
{
...
std::pair<Real, Real>
FaceTwoGate::translate_dis(std::pair<Real, Real> dis, const int edge_id, FaceBase_sptr face_ptr)
{
  std::pair<Real, Real> n_a_vec( face_ptr->get_para_a_neighbor_at(edge_id) );
  std::pair<Real, Real> n_b_vec( face_ptr->get_para_b_neighbor_at(edge_id) );
...
bool
FaceTwoGate::in_face(const std::pair<Real, Real>& parameters, const Real tol )
{
...
int
FaceTwoGate::through_edge(const std::pair<Real, Real>& position,
...
Real
FaceTwoGate::cross_ratio( const std::pair<Real, Real>& position,
...
*/
bool
FaceTwoGate::on_edge(const std::pair<Real, Real>& position,
...
std::pair<Real, Real> FaceTwoGate::reverse( const std::pair<Real, Real>& dis, const int edge_num )
{
...
std::pair<Real, Real> FaceTwoGate::to_parametric( const Realvec& pos )
{
  Real alpha, beta;
...
Realvec FaceTwoGate::to_absolute( const std::pair<Real, Real>& parameters )
{
...
void FaceTwoGate::set_neighbors_edge()
{
  for(int i(0); i<3; ++i)
  {
    if( !is_gate.at(i) ) continue;
...
void FaceTwoGate::set_neighbors_ori_vtx()
{
  for(int i(0); i<3; ++i)
  {
    if( !is_gate.at(i) ) continue;
