...
int main()
{
  ...
  FaceBase_sptr tryangle4_ptr( new FaceOpen(4, v6, v7, v8, gate1) );
  FaceBase_sptr tryangle4_5_ptr( new FaceOpen(8, v8, v7, v5, gate2) );
  FaceBase_sptr tryangle5_ptr( new FaceOpen(5, v8, v5, v3, gate1) );
