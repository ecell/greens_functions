...
int main()
{
  ...
  FaceBase_sptr tryangle4_ptr( new FaceTwoGate(4, v6, v7, v8, 0, 1) );
  FaceBase_sptr tryangle4_5_ptr( new FaceTwoGate(8, v8, v7, v5, 0, 2) );
  FaceBase_sptr tryangle5_ptr( new FaceTwoGate(5, v8, v5, v3, 0, 1) );
