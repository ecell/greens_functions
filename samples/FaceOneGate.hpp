...
public:
  ...
  : FaceBase( id, cross_product(vtx1-vtx0, vtx2-vtx0), vtx1-vtx0 ),
    vertexs(3), edges(3), angles(3), gateway(gate), is_gate(3)
  {
    vertexs.at(0) = vtx0;
    vertexs.at(1) = vtx1;
    vertexs.at(2) = vtx2;
...
bool
FaceOneGate::in_this_face(const Real& alpha, const Real& beta)
{
...
int
FaceOneGate::through_edge( const Real& pos_alpha, const Real& pos_beta,
...
Real
FaceOneGate::intersection_ratio( const Real& pos_alpha, const Real& pos_beta,
...
*/
bool
FaceOneGate::on_edge(const Real& alpha, const Real& beta,
		     int& edge_num)
{
  Real eps(1e-10);
...
void FaceOneGate::reverse( Real& dis_alpha, Real& dis_beta, const int edge_num )
{
  switch(edge_num)
  {
    case 0:
...
void FaceOneGate::to_parametric( const Realvec& pos, Real& alpha, Real& beta )
{
...
Realvec FaceOneGate::to_absolute( const Real& alpha, const Real& beta )
{
